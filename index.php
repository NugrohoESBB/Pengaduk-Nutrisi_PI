...
<script>
    ...
    $(document).ready(function() {
        ...
        const nutC = document.getElementById('Cnutrisi').getContext('2d');
        const nutCchart = new Chart(nutC, {
            type: 'line',
            data: {
                labels: <?php echo $json_datawaktu; ?>,
                datasets: [{
        ...
        const waT = document.getElementById('WWater').getContext('2d');
        const waTchart = new Chart(waT, {
            type: 'line',
            data: {
